...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma restore_sysreg_state_body_correct:
      forall m d d' env le rec_base rec_offset
             (Henv: env = PTree.empty _)
             (Hinv: high_level_invariant d)
             (HPTrec: PTree.get _rec le = Some (Vptr rec_base (Int.repr rec_offset)))
             (Hspec: restore_sysreg_state_spec0 (rec_base, rec_offset) d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) restore_sysreg_state_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec restore_sysreg_state_body.
      eexists.
      ...
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen.  vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. big_vcgen. solve_func64 z2. reflexivity.
      symmetry. sstep. assumption. somega.
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen. vcgen.  solve_proof_low.
      ...
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen. vcgen. big_vcgen. solve_func64 z4. reflexivity.
      symmetry. sstep. assumption. somega.
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen. vcgen.
      vcgen. vcgen. vcgen. vcgen. vcgen.  solve_proof_low.
