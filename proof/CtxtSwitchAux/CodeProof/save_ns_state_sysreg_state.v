...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma save_ns_state_sysreg_state_body_correct:
      forall m d d' env le
             (Henv: env = PTree.empty _)
             (Hinv: high_level_invariant d)
             (Hspec: save_ns_state_sysreg_state_spec0  d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) save_ns_state_sysreg_state_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec save_ns_state_sysreg_state_body.
      eexists.
